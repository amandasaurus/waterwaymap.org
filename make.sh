...
/home/amanda/code/rust/osm-lump-ways/target/release/osm-lump-ways -i ~/osm-data/britain-and-ireland-latest.osm.pbf -o "${TMP}.geojson" -f waterway=river,stream,ditch --min-length-m 100 --timeout-dist-to-longer-s 0 --no-incl-wayids
