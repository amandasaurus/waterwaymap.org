...
WANTED_VERSION="osm-lump-ways 3.10.0"
...
jq <./upload_to_cloudflare/tilesets.json '.tilesets[8].key = "planet-waterway-canals"|.tilesets[8].text = "Canals"' | sponge ./upload_to_cloudflare/tilesets.json
